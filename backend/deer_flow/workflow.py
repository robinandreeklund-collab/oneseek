...
from backend.deer_flow.graph import build_graph
from backend.deer_flow.graph.utils import build_clarified_topic_from_history
...
async def run_agent_workflow_async(
    ...
    if final_state and isinstance(final_state, dict):
        from backend.deer_flow.graph.nodes import needs_clarification
